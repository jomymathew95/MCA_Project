USE [testdb]
GO
/****** Object:  StoredProcedure [dbo].[jomy_order4]    Script Date: 8/22/2019 9:34:22 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
alter procedure [dbo].[jomy_order4]
as
--exec jomy_order4
begin
							...
							while @@FETCH_STATUS=0
						              ...
						              if (@qty>@qty_in)
										...
										set @qty=@qty-@qty_in
												...
												set @inindate =@trade_date_in
												set @ininid=@orderid_in
												set @inin_sell_qty=@qty_in
												set @inin_rate=@rate_in
												set @c=@qty_in-@qty
